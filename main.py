...
# Form implementation generated from reading ui file 'hopy.ui'
#
...
"")
        ...
        self.afd_btn.clicked.connect(self._afdFileSelect) #chamada de função <==>
...
"borde-radius:2px;")
        ...
        self.xlsx_btn.clicked.connect(self._xlsFileSelect)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        # item = self.xlsx_listWidget.item(1)
        # item.setText(_translate("Form", "XLSX files 02"))
        # item = self.xlsx_listWidget.item(2)
        # item.setText(_translate("Form", "XLSX files 03"))
        # item = self.xlsx_listWidget.item(3)
        # item.setText(_translate("Form", "XLSX files 04"))
        # item = self.xlsx_listWidget.item(4)
        # item.setText(_translate("Form", "XLSX files 05"))
